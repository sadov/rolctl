...
// NewPutHostNetworkVlanNameParams creates a new PutHostNetworkVlanNameParams object,
...
func NewPutHostNetworkVlanNameParams() *PutHostNetworkVlanNameParams {
	return &PutHostNetworkVlanNameParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPutHostNetworkVlanNameParamsWithTimeout creates a new PutHostNetworkVlanNameParams object
...
// NewPutHostNetworkVlanNameParamsWithContext creates a new PutHostNetworkVlanNameParams object
...
// NewPutHostNetworkVlanNameParamsWithHTTPClient creates a new PutHostNetworkVlanNameParams object
...
func (o *PutHostNetworkVlanNameParams) WithDefaults() *PutHostNetworkVlanNameParams {
	o.SetDefaults()
	return o
}
...
func (o *PutHostNetworkVlanNameParams) WithTimeout(timeout time.Duration) *PutHostNetworkVlanNameParams {
...
func (o *PutHostNetworkVlanNameParams) WithContext(ctx context.Context) *PutHostNetworkVlanNameParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutHostNetworkVlanNameParams) WithHTTPClient(client *http.Client) *PutHostNetworkVlanNameParams {
...
func (o *PutHostNetworkVlanNameParams) WithName(name string) *PutHostNetworkVlanNameParams {
	o.SetName(name)
	return o
}
...
func (o *PutHostNetworkVlanNameParams) WithRequest(request *models.DtosHostNetworkVlanUpdateDto) *PutHostNetworkVlanNameParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the put host network vlan name params
func (o *PutHostNetworkVlanNameParams) SetRequest(request *models.DtosHostNetworkVlanUpdateDto) {
	o.Request = request
}

// WriteToRequest writes these params to a swagger request
func (o *PutHostNetworkVlanNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
