...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) validateItems(formats strfmt.Registry) error {
...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) validatePagination(formats strfmt.Registry) error {
...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) contextValidatePagination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtosPaginatedItemsDtoDtosHTTPLogDto) UnmarshalBinary(b []byte) error {
	var res DtosPaginatedItemsDtoDtosHTTPLogDto
