...
func (m *DtosValidationErrorDto) validateErrors(formats strfmt.Registry) error {
...
func (m *DtosValidationErrorDto) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtosValidationErrorDto) UnmarshalBinary(b []byte) error {
	var res DtosValidationErrorDto
